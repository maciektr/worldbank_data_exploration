...
class Autoencoder:
    ...
    def __init__(self, n_bottleneck, input_len=21, model_path=None):
        ...
        if model_path is None:
            self.model_path = f'model_weights/autoencoder/{n_bottleneck}'

        self.encoder, self.autoencoder = self._build_model()
        self.history = None

    def compile_and_train(self, X, batch_size=256, n_epochs=100, lr=0.001, lr_patience=150, min_lr=0.00005,
    ...
    def load_weights(self):
        ...
        :return: self
        """
        self.history = pd.read_csv(f'{self.model_path}/loss_log.csv')
        self.autoencoder.load_weights(f'{self.model_path}/weights')
    ...
    def autoencode(self, X, normalize=True):
        """
...
if __name__ == '__main__':
    ...
    print('==============================================================================')
    print(X[3])
    print(autoencoder.autoencode(X)[3])
